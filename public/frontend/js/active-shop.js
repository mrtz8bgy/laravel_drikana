...
$(document).ready(function () {
	...
	var slLow = $('#input-slider-range-value-low').text();
	$('#input-slider-range-value-low').text(parseInt(slLow));
	var slHigh = $('#input-slider-range-value-high').text();
	$('#input-slider-range-value-high').text(parseInt(slHigh));
    // Flip cards
    if ($(".card-flip")[0]) {
        ...
        $(".countdown").each(function () {
            ...
            $this.countdown(date).on("update.countdown", function (event) {
                var $this = $(this).html(
                    event.strftime(
                        "" +
                            '<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-label countdown-days">روز</span></div>' +
                            '<div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-separator">:</span><span class="countdown-label">ساعت</span></div>' +
                            '<div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-separator">:</span><span class="countdown-label">دقیقه</span></div>' +
                            '<div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-label">ثانیه</span></div>'
                    )
                );
            });
        });
