...
$(function () {
    $('#start-date').MdPersianDateTimePicker({
        targetTextSelector: '#start-date',
        targetDateSelector: '#start-date-gregorian',
    ...
    $('#end-date').MdPersianDateTimePicker({
        targetTextSelector: '#end-date',
        targetDateSelector: '#end-date-gregorian',
        fromDate: true,
        groupId: 'rangeSelector1',
        dateFormat: 'yyyy-MM-dd',
        textFormat: 'yyyy/MM/dd', 
    });
    $('#order-date').MdPersianDateTimePicker({
        targetTextSelector: '#order-date',
        targetDateSelector: '#order-date-gregorian',
        fromDate: true,
        groupId: 'rangeSelector1',
        dateFormat: 'yyyy-MM-dd HH:mm:ss',
        textFormat: 'HH:mm | yyyy/MM/dd',
        disable: true
    });
    $('.order-date').MdPersianDateTimePicker({
        targetTextSelector: '.order-date',
    ...
    $('#ticket-date-1').MdPersianDateTimePicker({
        targetTextSelector: '#ticket-date-1',
        targetDateSelector: '#ticket-date-gregorian-1',
        fromDate: true,
        groupId: 'rangeSelector1',
        dateFormat: 'yyyy-MM-dd HH:mm:ss',
        textFormat: 'HH:mm | yyyy/MM/dd',
    ...
    $('#ticket-date-2').MdPersianDateTimePicker({
        targetTextSelector: '#ticket-date-2',
        targetDateSelector: '#ticket-date-gregorian-2',
        fromDate: true,
        groupId: 'rangeSelector1',
        dateFormat: 'yyyy-MM-dd HH:mm:ss',
        textFormat: 'HH:mm | yyyy/MM/dd',
    ...
    $('#ticket-date-3').MdPersianDateTimePicker({
        targetTextSelector: '#ticket-date-3',
        targetDateSelector: '#ticket-date-gregorian-3',
        fromDate: true,
        groupId: 'rangeSelector1',
        dateFormat: 'yyyy-MM-dd HH:mm:ss',
        textFormat: 'HH:mm | yyyy/MM/dd',
