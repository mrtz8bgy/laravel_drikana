			...
			<div class="panel-body">
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
						...
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-7" aria-expanded="false">توضیحات</a>
				        </li>
				    </ul>
				    ...
				    <div class="tab-content">
						...
						<div id="demo-stk-lft-tab-4" class="tab-pane fade">
						    ...
						    <div class="form-group">
								<label class="col-lg-2 control-label">{{__('پیوند یکتا')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="slug" value="{{ $product->slug }}" placeholder="{{__('پیوند یکتا')}}">
								</div>
							</div>
