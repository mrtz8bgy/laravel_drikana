                        ...
                        <div class="card">
                            <div class="card-header py-3">
                                ...
                                <ul class="list-inline alpha-6 mb-0">
                                    ...
                                    <li class="list-inline-item"><span class="badge badge-pill badge-secondary">باز</span></li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="border-bottom pb-4">
                                    <form class="" action="{{route('support_ticket.seller_store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control editor" name="reply" placeholder="متن خود را وارد کنید" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo"></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-base-1">{{__('ارسال')}}</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="pt-4">
                                                ...
                                                <div class="d-flex flex-row-reverse">
                                                    ...
                                                    <div class="flex-grow-1 ml-5 pl-5">
                                                        ...
                                                        <span class="comment-date alpha-5 text-sm mt-1 d-block text-right">
                                                            <input type="text" class="disabled-persian-date order-date" value="{{ date('d/m/Y h:i', strtotime($ticketreply->created_at)) }}">
							                                <input type="hidden" class="order-date-gregorian" value="{{ date('d/m/Y h:i', strtotime($ticketreply->created_at)) }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="block block-comment mb-3 border-0">
                                        <div class="d-flex flex-row-reverse">
                                            ...
                                            <div class="flex-grow-1 ml-5 pl-5">
                                                ...
                                                <span class="comment-date alpha-5 text-sm mt-1 d-block text-right">
                                                    <input type="text" class="disabled-persian-date order-date" value="{{ date('d/m/Y h:i', strtotime($ticket->created_at)) }}">
							                        <input type="hidden" class="order-date-gregorian" value="{{ date('d/m/Y h:i', strtotime($ticket->created_at)) }}">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
