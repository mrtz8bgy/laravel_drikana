                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('support_ticket.show', encrypt($ticket->id))}}" class="btn btn-styled btn-link py-1 px-0 icon-anim text-underline--none">
                                                    {{__('مشاهده تیکت')}}
                                                    <i class="la la-angle-left text-sm"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            <div class="modal-body px-3 pt-3">
                <form class="" action="{{ route('support_ticket.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" name="subject" placeholder="موضوع" required>
                    </div>
                    <div class="form-group">
                        <label>توضیحات خود را وارد کنید <span class="text-danger">*</span></label>
                        <textarea class="form-control editor" name="details" placeholder=" " data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo"></textarea>
                    </div>
                    <div class="form-group">
