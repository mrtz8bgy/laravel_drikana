                            ...
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-link p-0" type="button" onclick="toggleEmailPhone(this)">استفاده از ایمیل</button>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        function toggleEmailPhone(el){
            if(isPhoneShown){
                ...
                isPhoneShown = false;
                $(el).html('استفاده از شماره موبایل');
            }
            else{
                $('.phone-form-group').show();
                $('.email-form-group').hide();
                isPhoneShown = true;
                $(el).html('استفاده از ایمیل');
            }
        }
    </script>
@endsection
