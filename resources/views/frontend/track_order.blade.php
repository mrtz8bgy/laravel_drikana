                            ...
                            <div class="col-lg-6">
                                <table class="details-table table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ json_decode($order->shipping_address)->city }}, {{ json_decode($order->shipping_address)->address }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <table class="details-table table">
                                    @if($orderDetail->product != null)
                                        <tr>
                                            ...
                                            <td class="yekan">{{ $orderDetail->product->name }} ({{ $orderDetail->variation }})</td>
                                        </tr>
                                        <tr>
