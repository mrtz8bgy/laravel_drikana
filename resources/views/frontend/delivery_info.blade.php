                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-white py-3">
                                    <h5 class="heading-6 mb-0">محصولات {{ \App\GeneralSetting::first()->site_name }} </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="table-cart">
                                                <tbody>
                                                    ...
                                                    <tr class="cart-item">
                                                        ...
                                                        <td class="product-name yekan strong-600">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <label class="d-flex align-items-center p-3 border rounded gry-bg c-pointer">
                                                        ...
                                                        <span class="d-block mr-2 strong-600">
                                                            {{ __('Home Delivery') }}
                                                        </span>
                                                    </label>
                                                </div>
                            ...
                            @if (!empty($seller_products))
                                @foreach ($seller_products as $key => $seller_product)
                                    <div class="card mb-3">
                                        <div class="card-header bg-white py-3">
                                            <h5 class="heading-6 mb-0"> محصولات {{ \App\Shop::where('user_id', $key)->first()->name }}</h5>
                                        </div>
                                        <div class="card-body">
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1">{{__('انتخاب شیوه پرداخت')}}</a>
                                </div>
                            </div>
                        </form>
                    </div>
