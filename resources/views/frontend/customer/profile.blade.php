                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" placeholder="{{__('شماره موبایل')}}" name="phone" value="{{ Auth::user()->phone }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row gutters-10">
                                        @foreach (Auth::user()->addresses as $key => $address)
                                            <div class="col-lg-6">
                                                <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                                    <div class="mb-2">
                                                        <span class="alpha-6">شهر:</span>
                                                        <span class="strong-600 mr-2">{{ $address->city }}</span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <span class="alpha-6">آدرس:</span>
                                                        <span class="strong-600 mr-2">{{ $address->address }}</span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <span class="alpha-6">کد پستی:</span>
                                                        <span class="strong-600 mr-2">{{ $address->postal_code }}</span>
                                                    </div>

                                                    <div class="mb-2">
                                                        <span class="alpha-6">تلفن:</span>
                                                        <span class="strong-600 mr-2">{{ $address->phone }}</span>
                                                    </div>
                                                    @if ($address->set_default)
                                                        <div class="position-absolute left-0 bottom-0 pl-2 pb-3">
                                                            <span class="badge badge-primary bg-base-1">پیش فرض</span>
                                                        </div>
                                                    @endif
                                                    <div class="dropdown position-absolute right-0 top-0">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                            @if (!$address->set_default)
                                                                <a class="dropdown-item" href="{{ route('addresses.set_default', $address->id) }}">انتخاب به عنوان پیش فرض</a>
                                                            @endif
                                                            {{-- <a class="dropdown-item" href="">Edit</a> --}}
                                                            <a class="dropdown-item" href="{{ route('addresses.destroy', $address->id) }}">حذف</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mx-auto" onclick="add_new_address()">
                                            <div class="border p-3 rounded mb-3 c-pointer text-center bg-light">
                                                ...
                                                <div class="alpha-7">افزودن آدرس جدید</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">{{__('آدرس جدید')}}</h6>
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="hidden" name="country" value="Iran (Islamic Republic of)">
