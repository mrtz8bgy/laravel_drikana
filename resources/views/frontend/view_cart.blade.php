                    ...
                    <div class="form-default bg-white p-4">
                                        ...
                                        @foreach (Session::get('cart') as $key => $cartItem)
                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-name">
                                                    <span class="pr-4 d-block yekan">{{ $product_name_with_choice }}</span>
                                                </td>
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                @if(Auth::check())
                                    <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">{{__('ادامه فرآیند خرید')}}</a>
                                @else
                                    <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()">{{__('ادامه فرآیند خرید')}}</button>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    @if (\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1)
                        ...
                        <div class="text-center">
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">{{__('خرید بدون ایجاد حساب کاربری')}}</a>
                        </div>
                    @endif
                </div>
            </div>
