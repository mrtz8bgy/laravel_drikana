                ...
                <div class="col-lg-6">
                    <table class="details-table table">
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($order->shipping_address)->city }},{{ json_decode($order->shipping_address)->address }}, {{ json_decode($order->shipping_address)->postal_code }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-lg-6">
                    <table class="details-table table">
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    $odate = \Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($odate));
                                @endphp
                                {{ $odate }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="w-50 strong-600">{{__('تلفن تماس')}}:</td>
