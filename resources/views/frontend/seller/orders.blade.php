                        ...
                        <div class="card no-border mt-4">
                            <div class="card-header">
                                <form id="sort_orders" action="" method="GET">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" id="search" name="search" @isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="کد سفارش را وارد کرده و اینتر بزنید">
                                        </div>
                                        <div class="col-md-3 mr-auto">
                                            <select class="form-control mb-3 selectpicker" data-placeholder="{{__('Filter by Payment Status')}}" name="payment_status" onchange="sort_orders()">
                                                ...
                                                <option value="unpaid" @isset($payment_status) @if($payment_status == 'unpaid') selected @endif @endisset>{{__('پرداخت نشده')}}</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <select class="form-control mb-3 selectpicker" data-placeholder="{{__('فیلتر بر اساس وضعیت سفارش')}}" name="delivery_status" onchange="sort_orders()">
