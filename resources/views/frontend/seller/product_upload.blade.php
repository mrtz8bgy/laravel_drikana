                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker" data-placeholder="برند محصول را انتخاب کنید" id="brands" name="brand_id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="unit" placeholder="واحد محصول">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags[]" placeholder="تایپ کنید و اینتر بزنید" data-role="tagsinput" required>
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-7">
                                            <div class="">
                                                <select name="choice_attributes[]" id="choice_attributes" class="form-control selectpicker" multiple data-placeholder="انتخاب ویژگی">
                                    ...
                                    <div class="mb-3">
        								<p>ویژگی های این محصول را انتخاب و سپس مقداری برای آن وارد کنید</p>
        							</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="target-category heading-6">
                        ...
                        <span>{{__('دسته بندی')}} > {{__('زیر مجموعه دسته بندی')}} > {{__('زیر مجموعه زیر مجموعه دسته بندی')}}</span>
                    </div>
                    <div class="row no-gutters modal-categories mt-4 mb-2">
                            ...
                            <div class="modal-category-box c-scrollbar">
                                <div class="sort-by-box">
                                    <form role="form" class="search-widget">
                                        <input class="form-control input-lg" type="text" placeholder="جستجوی دسته بندی" onkeyup="filterListItems(this, 'categories')">
                        ...
                        <div class="col-4">
                            <div class="modal-category-box c-scrollbar" id="subcategory_list">
                                <div class="sort-by-box">
                                    <form role="form" class="search-widget">
                                        <input class="form-control input-lg" type="text" placeholder="جستجوی زیر مجموعه" onkeyup="filterListItems(this, 'subcategories')">
                                        <button type="button" class="btn-inner">
                                            <i class="fa fa-search"></i>
                                        </button>
                                    </form>
                        ...
                        <div class="col-4">
                            <div class="modal-category-box c-scrollbar" id="subsubcategory_list">
                                <div class="sort-by-box">
                                    <form role="form" class="search-widget">
                                        <input class="form-control input-lg" type="text" placeholder="جستجوی زیر مجموعه زیر مجموعه" onkeyup="filterListItems(this, 'subsubcategories')">
                                        <button type="button" class="btn-inner">
                                            <i class="fa fa-search"></i>
                                        </button>
                                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{__('لغو')}}</button>
