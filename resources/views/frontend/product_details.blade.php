                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                    <div class="product-description-label ml-2">
                                    {{__('Sold by')}}:
                                    </div>
                            ...
                            @endphp
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1 && $product->refundable)
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                            ...
                            @if($detailedProduct->added_by == 'seller')
                                ...
                                <div class="col">
                                    <ul class="social-media social-media--style-1-v4 text-center">
                                        <li>
                                            <a href="{{ $detailedProduct->user->shop->facebook }}" class="facebook" target="_blank" data-toggle="tooltip" data-original-title="{{__('Facebook')}}">
                                                <i class="fa fa-facebook"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ $detailedProduct->user->shop->google }}" class="google" target="_blank" data-toggle="tooltip" data-original-title="{{__('Google')}}">
                                                <i class="fa fa-google"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ $detailedProduct->user->shop->twitter }}" class="twitter" target="_blank" data-toggle="tooltip" data-original-title="{{__('Twitter')}}">
                                                <i class="fa fa-twitter"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ $detailedProduct->user->shop->youtube }}" class="youtube" target="_blank" data-toggle="tooltip" data-original-title="{{__('Youtube')}}">
