    ...
    <div class="col-lg-10 col-lg-offset-1">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('ایجاد بسته جدید')}}</h3>
            </div>
            ...
            <form class="form-horizontal" action="{{ route('customer_packages.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="name">{{__('نام بسته')}}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="logo">{{__('لوگوی بسته')}}</label>
                        <div class="col-sm-10">
