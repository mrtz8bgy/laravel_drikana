    	...
    	<div class="panel-body">
    		<div class="invoice-masthead">
    			<div class="invoice-text">
    				<h3 class="h3 mar-no text-primary">{{ __('Order Details') }}</h3>
    			</div>
    		</div>
            <div class="row">
                @php
                ...
                <div class="col-lg-offset-6 col-lg-3">
                    ...
                    <select class="form-control demo-select2"  data-minimum-results-for-search="Infinity" id="update_payment_status">
                        <option value="paid" @if ($payment_status == 'paid') selected @endif>{{__('پرداخت شده')}}</option>
                        <option value="unpaid" @if ($payment_status == 'unpaid') selected @endif>{{__('پرداخت نشده')}}</option>
                    </select>
                </div>
                <div class="col-lg-3">
