<div class="panel-heading">
    <h3 class="panel-title">{{__('ویرایش کد تخفیف بر روی محصول')}}</h3>
</div>
    ...
    @foreach (json_decode($coupon->details) as $key => $details)
        <div class="product-choose">
            ...
            <div class="form-group" id="subcategory">
               <label class="col-lg-3 control-label">{{__('زیر مجموعه دسته بندی')}}</label>
               <div class="col-lg-9">
...
<div class="form-group">
   ...
   <div class="col-lg-1">
      <select class="demo-select2" name="discount_type">
         <option value="amount" @if ($coupon->discount_type == 'amount') selected  @endif>مبلغ</option>
         <option value="percent" @if ($coupon->discount_type == 'percent') selected  @endif>درصد</option>
      </select>
   </div>
</div>
