                            ...
                            @if ($flash_deal_product != null)
                                ...
                                <td>
                                    <select class="demo-select2" name="discount_type_{{ $id }}">
                                        <option value="amount" <?php if($flash_deal_product->discount_type == 'amount') echo "selected";?> >مبلغ</option>
                                        <option value="percent" <?php if($flash_deal_product->discount_type == 'percent') echo "selected";?> >درصد</option>
                                    </select>
                                </td>
                            @else
                                <td>
