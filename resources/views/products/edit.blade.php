...
<div class="text-center">
    <h1 class="page-header text-overflow">ویرایش محصول</h1>
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="unit" placeholder="واحد(مثال: کیلو گرم)" value="{{$product->unit}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">{{__('Tags')}}</label>
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="tags[]" id="tags" value="{{ $product->tags }}" data-role="tagsinput">
                        </div>
                    </div>
					@php
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">تصاویر محصول</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-lg-2 control-label">گالری تصاویر</label>
						<div class="col-lg-7">
							<div id="photos">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">پیشنهاد شگفت انگیز <small>(290x300)</small></label>
						<div class="col-lg-7">
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">ویدیو محصول</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">ویژگی محصول</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<div class="col-lg-2">
					...
					<div class="form-group">
	                    ...
	                    <div class="col-lg-7">
	                        <select name="choice_attributes[]" id="choice_attributes" class="form-control demo-select2" multiple data-placeholder="انتخاب ویژگی">
					...
					<div class="">
						<p>ویژگی های این محصول و سپس مقادیر ورودی هر ویژگی را انتخاب کنید</p>
						<br>
					</div>
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">قیمت و موجودی انبار</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="number" min="0"  placeholder="{{__('tax')}}" name="tax" class="form-control" value="{{$product->tax}}" required>
                        </div>
                        <div class="col-lg-2">
                            <select class="form-control" name="tax_type">
								<option value=""></option>
                            	<option value="amount" <?php if($product->tax_type == 'amount') echo "selected";?> >مبلغ</option>
                            	<option value="percent" <?php if($product->tax_type == 'percent') echo "selected";?> >درصد</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="number" min="0"  placeholder="{{__('Discount')}}" name="discount" class="form-control" value="{{ $product->discount }}" required>
                        </div>
                        <div class="col-lg-2">
                            <select class="form-control" name="discount_type">
								<option value=""></option>
                            	<option value="amount" <?php if($product->discount_type == 'amount') echo "selected";?> >مبلغ</option>
                            	<option value="percent" <?php if($product->discount_type == 'percent') echo "selected";?> >درصد</option>
                            </select>
                        </div>
                    </div>
			...
			@if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'product_wise_shipping')
                <div class="panel">
    				<div class="panel-heading bord-btm">
    					<h3 class="panel-title">هزینه ارسال</h3>
    				</div>
    				<div class="panel-body">
    					<div class="row bord-btm">
							...
							<div class="col-md-3">
    							<div class="panel-heading">
    								<h3 class="panel-title">ارسال رایگان</h3>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="row bord-btm">
    						<div class="col-md-9">
    							...
    							<div class="form-group">
    								...
    								<div class="col-lg-7">
    									<input type="number" min="0"  placeholder="{{__('Shipping cost')}}" name="flat_shipping_cost" class="form-control" value="{{ $product->shipping_cost }}" required>
    								</div>
    							</div>
							</div>
							<div class="col-md-3">
    							<div class="panel-heading">
    								<h3 class="panel-title"> ارسال با هزینه</h3>
    							</div>
    						</div>
    					</div>
    				</div>
			...
			<div class="mar-all text-right">
				<button type="submit" name="button" class="btn btn-info">بروزرسانی محصول</button>
			</div>
		</form>
	</div>
</div>
