...
<div class="text-center">
    <h1 class="page-header text-overflow">افزودن محصول جدید</h1>
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group" id="subsubcategory">
						...
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="subsubcategory_id" id="subsubcategory_id" data-placeholder="انتخاب زیرمجموعه زیرمجموعه">
					...
					<div class="form-group" id="brand">
						...
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="brand_id" id="brand_id" data-placeholder="انتخاب برند">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="unit" placeholder="واحد(مثال: کیلو گرم)">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{__('Tags')}}</label>
						<div class="col-lg-7">
							<input type="text" class="form-control" name="tags[]" placeholder="" data-role="tagsinput">
						</div>
					</div>
					@php
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">ویژگی های محصول</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<div class="col-lg-2">
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">قیمت محصول و موجودی انبار</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" min="0" value="0" placeholder="{{__('Tax')}}" name="tax" class="form-control" required>
						</div>
						<div class="col-lg-2">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" min="0" value="0"  placeholder="{{__('Discount')}}" name="discount" class="form-control" required>
						</div>
						<div class="col-lg-2">
    					...
    					<div class="row">
    						...
    						<div class="col-md-9">
    							...
    							<div class="form-group">
    								...
    								<div class="col-lg-7">
    									<input type="number" min="0" value="0"  placeholder="{{__('Shipping cost')}}" name="flat_shipping_cost" class="form-control" required>
    								</div>
    							</div>
							</div>
							<div class="col-md-3">
