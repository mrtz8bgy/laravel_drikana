    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="name">{{__('پیوند یکتا')}}</label>
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('پیوند یکتا')}}" id="slug" name="slug" value="{{ $category->slug }}" class="form-control">
                    </div>
                </div>
