    	...
    	<div class="panel-body">
    		<div class="invoice-masthead">
    			<div class="invoice-text">
    				<h3 class="h3 text-medium mar-no text-primary">{{ __('Order Details') }}</h3>
    			</div>
    		</div>
            <div class="row">
                @php
    		...
    		<div class="invoice-bill row">
    			<div class="col-sm-6 text-xs-center">
    				<address>
        				<strong class="text-main">{{ json_decode($order->shipping_address)->name }}</strong><br><br>
                         {{ json_decode($order->shipping_address)->email }}<br><br>
                         {{ json_decode($order->shipping_address)->phone }}<br><br>
    			...
    			<div class="col-sm-6 text-xs-center">
    				...
    				<tr>
    					...
    					<td class="text-right">
							<input type="text" class="disabled-persian-date" id="order-date" value="{{ date('m/d/Y h:i', $order->date) }}">
							<input type="hidden" id="order-date-gregorian" value="{{ date('m/d/Y h:i', $order->date) }}">
    					</td>
    				</tr>
                    <tr>
    					<td class="text-main text-bold">
