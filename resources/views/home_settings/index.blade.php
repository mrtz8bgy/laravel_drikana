...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-2" aria-expanded="false">{{ __('بنر اول صفحه اصلی') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-4" aria-expanded="false">{{ __('دسته بندی ها') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-3" aria-expanded="false">{{ __('بنر دوم صفحه اصلی') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false">{{ __('10 تای برتر') }}</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div id="demo-lft-tab-2" class="tab-pane fade">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Home banner')}} (حداکثر 3 بنر منتشر شود)</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
            ...
            <div id="demo-lft-tab-5" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('اطلاعات ده تای برتر')}}</h3>
                    </div>
                    ...
                    <form class="form-horizontal" action="{{ route('top_10_settings.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{__('۱۰ دسته بندی برتر')}}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{__('۱۰ برند برتر')}}</label>
                                <div class="col-sm-9">
...
<script type="text/javascript">
    ...
    function updateSettings(el, type){
        ...
        $.post('{{ route('business_settings.update.activation') }}', {_token:'{{ csrf_token() }}', type:type, value:value}, function(data){
            if(data == 1){
                showAlert('success', 'تنظیمات با موفقیت بروز شد');
            }
            else{
    ...
    function update_banner_published(el){
        ...
        $.post('{{ route('home_banners.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
            if(data == 1){
                ...
                showAlert('danger', 'حداکثر 4 بنر میتواند منتشر شود');
            }
        });
    }
