        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="slug">{{__('آدرس صفحه')}}</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{__('پیوند یکتا')}}" id="slug" name="slug" value="{{ $page->slug }}" class="form-control" required>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="meta_description">{{__('توضیحات متا')}}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="keywords">{{__('کلمات کلیدی')}}</label>
                        <div class="col-sm-9">
