    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('subsubcategories.update', $subsubcategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="name">{{__('پیوند یکتا')}}</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{__('پیوند یکتا')}}" id="slug" name="slug" value="{{ $subsubcategory->slug }}" class="form-control">
                    </div>
                </div>
            </div>
