                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <select name="text_color" id="text_color" class="form-control demo-select2" required>
                            ...
                            <option value="white" @if ($flash_deal->text_color == 'white') selected @endif>{{__('سفید')}}</option>
                            <option value="dark" @if ($flash_deal->text_color == 'dark') selected @endif>{{__('تیره')}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div id="demo-dp-range">
                            <div class="input-daterange input-group" id="datepicker">
                                <input type="text" class="form-control" id="start-date" value="{{ date('m/d/Y', $flash_deal->start_date) }}">
                                <input type="hidden" name="start_date" id="start-date-gregorian" value="{{ date('m/d/Y', $flash_deal->start_date) }}">
                                <span class="input-group-addon">{{__('to')}}</span>
                                <input type="text" class="form-control" id="end-date" value="{{ date('m/d/Y', $flash_deal->end_date) }}">
                                <input type="hidden" name="end_date" id="end-date-gregorian" value="{{ date('m/d/Y', $flash_deal->end_date) }}">
                            </div>
                        </div>
                    </div>
                </div>
