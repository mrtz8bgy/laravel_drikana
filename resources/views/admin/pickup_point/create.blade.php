    ...
    <div class="col-lg-8 col-lg-offset-2">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('اطلاعات مرکز دریافت حضوری')}}</h3>
            </div>
            ...
            <form class="form-horizontal" action="{{ route('pick_up_points.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="name">{{__('انتخاب مدیر مرکز')}}</label>
                        <div class="col-sm-9">
                            <select name="staff_id" class="form-control demo-select2-placeholder" data-placeholder="انتخاب کنید" required>
