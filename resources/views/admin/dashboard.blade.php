    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="bg-danger pad-all text-center mar-btm">
                ...
                <a class="btn btn-info btn-rounded" href="{{ route('smtp_settings.index') }}">تنظیمات</a>
            </div>
        </div>
    </div>
@endif
    ...
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <a href="{{ route('products.admin') }}" class="btn btn-primary mar-top">مدیریت محصولات <i class="fa fa-long-arrow-left"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-normal text-main">همه فروشندگان</p>
                <p class="text-semibold text-3x text-main">{{ \App\Seller::all()->count() }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-left"></i></a>
                <br>
                <br>
            </div>
        </div>
