        ...
        <form class="form-horizontal" action="{{ route('newsletters.send') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control news-selectpicker" name="user_emails[]" multiple data-selected-text-format="count" data-actions-box="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control news-selectpicker" name="subscriber_emails[]" multiple data-selected-text-format="count" data-actions-box="true">
