        ...
        <div class="text-right">
            ...
            <div class="text-center">
                ...
                <div class="pad-ver btn-groups">
                    <a href="{{ $seller->user->shop->facebook }}" class="btn btn-icon demo-pli-facebook icon-lg add-tooltip" data-original-title="{{__('Facebook')}}" data-container="body"></a>
                    <a href="{{ $seller->user->shop->twitter }}" class="btn btn-icon demo-pli-twitter icon-lg add-tooltip" data-original-title="{{__('Twitter')}}" data-container="body"></a>
            ...
            <!-- Profile Details -->
            <p class="pad-ver text-main text-sm text-uppercase text-bold">{{__('اطلاعات')}} {{ $seller->user->name }}</p>
