        ...
        <div class="panel-body">
            <form class="" action="{{ route('support_ticket.admin_store') }}" method="post" id="ticket-reply-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <textarea class="editor" name="reply" placeholder="متن خود را وارد کنید" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo" required></textarea>
                </div>
                <div class="form-group">
                    <input type="file" name="attachments[]" class="form-control" multiple>
                </div>
                <div class="form-group text-left pos-rel">
                    <button type="button" class="btn btn-primary" onclick="submit_reply('pending')">ارسال</button>
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li onclick="submit_reply('open')"><a href="#">ارسال با وضعیت باز</strong></a></li>
                        <li onclick="submit_reply('solved')"><a href="#">بستن تیکت</strong></a></li>
                        ...
                        <div class="media-body">
                            <div class="comment-header">
                                ...
                                <p class="text-muted text-sm">
                                    <input type="text" class="disabled-persian-date order-date" value="{{ $ticketreply->created_at }}">
							        <input type="hidden" class="order-date-gregorian" value="{{ $ticketreply->created_at }}">
                                </p>
                            </div>
                            <div>
                                @php
