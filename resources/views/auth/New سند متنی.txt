...
<div class="flex-row" id="login-box">
        ...
        <div class="text-center">
            ...
            <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus placeholder="نام کاربری">
                ...
                <div class="form-group">
                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="رمز عبور">
